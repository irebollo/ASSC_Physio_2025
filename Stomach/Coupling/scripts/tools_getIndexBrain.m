function    [output] = tools_getIndexBrain(insideOutside,cfgMain)
...
% mask = ft_read_mri (strcat('D:\NAVIGASTRIC\test2pipelines\scripts\stomachBrainNavigastricTest2pipelines\files\','SPM_mask_THRESHOLDED_physiens.hdr'));
    ...
    mask = ft_read_mri (strcat(cfgMain.RootPath,filesep,'scripts',filesep,'files',filesep','SPM_mask_THRESHOLDED_physiens.hdr'));
