function EGG_filt = compute_filter_EGG_peakchan(EGG_raw, FFT_EGG)
...
% 
% Outputs
%     data_EGG        data structure containing EGG raw signal, filtered 
...
cfg = [];
cfg.channel         = FFT_EGG.logEGGpreprocessing.bestChannel; %FFT_EGG.max_chan{1};
...
center_frequency    = FFT_EGG.logEGGpreprocessing.mostPowerfullFrequency; %FFT_EGG.max_freq;        
bandwidth           = 0.015;
